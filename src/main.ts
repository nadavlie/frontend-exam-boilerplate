...
const currency_choice = document.querySelector("#currency_choice");

currency_choice?.addEventListener("click", function () {
  for (const item of currencyNames) {
    const html = `<option value="${item}"></option>`;
    console.log(item);
